    ...
    class Question1 {
        public static void main(String[] args) {
            String[] subjects = {"Nepali", "English", "Science", "social", "Computer"};
    ...
    class SwitchQuestion4 {
        public static void main(String[] args) {
            ...
            switch ((num1 % 5 == 0 && num1 % 11 == 0) ? 1 : 0) {
                case 1 -> System.out.println(" IS Divisible by 5 and 11!");
                case 0 -> System.out.println("Not divisible by 5 and 11!");
            }
        }
    }

    class SwitchQuestion5 {
        public static void main(String[] args) {
            Scanner input = new Scanner(System.in);
