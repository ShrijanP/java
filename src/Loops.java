...
class LoopQuestion21 {
    public static void main(String[] args) {
        ...
        System.out.println("Congratulations! You guessed  number is right!");
    }
}

class LoopQuestion22 {
    public static void main(String[] args) {
